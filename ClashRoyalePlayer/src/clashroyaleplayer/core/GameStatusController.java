...
public class GameStatusController {
	...
	public static enum GameStatus {
		BATTLE_MENU, TOURNAMENTS_MENU, SOCIAL_MENU, SHOP_MENU, CARDS_MENU, IN_BATTLE, END_BATTLE, ARENA_INFO, REWARD_LIMIT_REACHED, UNKNOWN
	}
	...
	public GameStatusController(AutoPlayer autoPlayer) throws Exception {
		...
		imageStore = new ImageStore("." + File.separator + "images" + File.separator);
	}
	...
	protected void checkGameStatus() throws AWTException {
		...
		} else if (imageComparison.imgEqual(battleMenu, capturedBattleMenu, 5))
		...
		else if (imageComparison.imgEqual(socialMenu, capturedSocialMenu, 5))
			gameStatus = GameStatus.SOCIAL_MENU;
		else if (imageComparison.imgEqual(tournamentsMenu, capturedTournamentsMenu, 5))
			gameStatus = GameStatus.TOURNAMENTS_MENU;
		else if (imageComparison.imgEqual(cardsMenu, capturedCardsMenu, 5))
	...
	protected void checkFirstChestStatus() throws AWTException {
		...
		if (imageComparison.imgEqual(lockedSilverChest, capturedFirstChest, 15)
		...
		} else if (imageComparison.imgEqual(unlockingSilverChest, capturedFirstChest, 15)
		...
		} else if (imageComparison.imgEqual(openSilverChest, capturedFirstChest, 15)
		...
		} else if (imageComparison.imgEqual(emptyChest, capturedFirstChest, 15)) {
	...
	protected void checkSecondChestStatus() throws AWTException {
		...
		if (imageComparison.imgEqual(lockedSilverChest, capturedSecondChest, 15)
		...
		} else if (imageComparison.imgEqual(unlockingSilverChest, capturedSecondChest, 15)
		...
		} else if (imageComparison.imgEqual(openSilverChest, capturedSecondChest, 15)
		...
		} else if (imageComparison.imgEqual(emptyChest, capturedSecondChest, 15)) {
	...
	protected void checkThirdChestStatus() throws AWTException {
		...
		if (imageComparison.imgEqual(lockedSilverChest, capturedThirdChest, 15)
		...
		} else if (imageComparison.imgEqual(unlockingSilverChest, capturedThirdChest, 15)
		...
		} else if (imageComparison.imgEqual(openSilverChest, capturedThirdChest, 15)
		...
		} else if (imageComparison.imgEqual(emptyChest, capturedThirdChest, 15)) {
	...
	protected void checkFourthChestStatus() throws AWTException {
		...
		if (imageComparison.imgEqual(lockedSilverChest, capturedFourthChest, 15)
		...
		} else if (imageComparison.imgEqual(unlockingSilverChest, capturedFourthChest, 15)
		...
		} else if (imageComparison.imgEqual(openSilverChest, capturedFourthChest, 15)
		...
		} else if (imageComparison.imgEqual(emptyChest, capturedFourthChest, 15)) {
	...
	protected void checkFreeChestStatus() throws AWTException {
		...
		if (imageComparison.imgEqual(capturedFreeChest, openFreeChestx1, 15)
	...
	protected void checkCollectingStatus() throws AWTException {
		...
		if (imageComparison.imgEqual(capturedCollectingChest, collectingSilverChest, 20)
		...
		} else if (imageComparison.imgEqual(capturedCollectedChest, collectedSilverChest, 20)
